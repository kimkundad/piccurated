            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="col-md-12 " style="padding-left: 1px;">
                  ...
                  <a class="btn btn-primary " href="{{url('admin/main_category/create')}}" >
                      ...
                      <td>
                        ...
                        <div class="btn-group flex-wrap">
  												...
  												<div class="dropdown-menu" role="menu">
  													...
  													<a class="dropdown-item text-1" href="{{url('admin/main_category/'.$u->id.'/edit')}}">แก้ไข</a>
  												<!--	<a class="dropdown-item text-1 text-danger" href="">ลบ</a> -->
                          <form  action="{{url('admin/main_category/'.$u->id)}}" method="post" onsubmit="return(confirm('Do you want Delete'))">
