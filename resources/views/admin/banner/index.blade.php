...
<div class="row">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="col-md-12 " style="padding-left: 1px;">
                  ...
                  <a class="btn btn-primary " href="{{url('admin/banner/create')}}" >
                      <i class="fa fa-plus"></i> เพิ่ม Banner</a>
                </div>
                <br><br>
             ...
             @if($objs)
                @foreach($objs as $u)
                    <tr id="{{$u->id}}">
                      <td><img src="{{url('assets/image/banner/'.$u->image_banner)}}" class="img-thumbnail" style="height:250px;" /></td>
                      <td>{{$u->url_banner}}</td>
                      <td>
                        <div class="switch switch-sm switch-success">
                          <input type="checkbox" name="switch" data-plugin-ios-switch
                          @if($u->status_banner == 1)
                          checked="checked"
                          @endif
                          />
                        </div>
                      ...
                      <td>
                        ...
                        <div class="btn-group flex-wrap">
                          ...
                          <form  action="{{url('admin/banner/'.$u->id)}}" method="post" onsubmit="return(confirm('Do you want Delete'))">
