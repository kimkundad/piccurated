            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{$category->name_main}}</li>
                    </ul>
                </nav>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="order-xl-2 order-lg-2 col-xl-9 col-lg-8">
                      <div class="shop-banner">
                          <img src="{{url('assets/image/image_main/'.$category->image_main)}}" alt="{{$category->name_main}}">
                      </div>
                        <h1 class="page-title"> {{$category->name_main}} </h1>
                        <div class="ht-product-tab">
                            ...
                            <div class="shop-content-wrapper">
                                <div class="shop-results" style="float: left;"><span>Sort By</span>
                                  <form action="{{url('category_main/'.$category->id)}}" method="get" enctype="multipart/form-data" style="float: left;">
                                    {{ csrf_field() }}
                              ...
                              @if($product)
                                 ...
                                 <div class="product-item">
                                    ...
                                    <div class="product-text">
                                        ...
                                        <h4 style="margin-bottom: 0px;"><a href="{{url('product/'.$u->id_pro)}}">{{$u->pro_name}}</a></h4>
                          ...
                          @if($hot)
	                        ...
	                        <div class="product-widget-item">
	                            ...
	                            <div class="product-wid-img">
	                                <a href="{{url('product/'.$k->id_pro)}}"><img src="{{url('assets/image/product/'.$k->pro_image)}}" alt=""></a>
	                            </div>
                                <div class="product-text">
                                    <h4 style="margin-bottom: 0px;"><a href="{{url('product/'.$k->id_pro)}}">{{$k->pro_name}}</a></h4>
